...
namespace PTSD {
    ...
    void PTSDSound::playSound(std::string path, int soundType, float vol, bool loop) {
        currentChannel++;
    ...
    void PTSDSound::playMusic(std::string path, bool loop)
    {
    ...
    void PTSDSound::changeMusic(std::string path, bool loop)
    {
