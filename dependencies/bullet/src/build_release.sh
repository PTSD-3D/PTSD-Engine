...
cd build_release
cmake -DCMAKE_INSTALL_PREFIX=${PWD}/../../RelWithDebInfo -DBUILD_PYBULLET=ON -DBUILD_PYBULLET_NUMPY=ON -DUSE_DOUBLE_PRECISION=ON -DBT_USE_EGL=ON -DCMAKE_BUILD_TYPE=Release .. || exit 1
